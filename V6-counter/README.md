...
| sw1    | Direction   | PIN\_DD24 | 1.1-V        |

| sw2    | Enable      | PIN\_DD27 | 1.1-V        |

| sw3    | Speed       | PIN\_DF27 | 1.1-V        |

| led0   | bit 0 (LSB) | PIN\_DF35 | 1.1-V        |

| led1   | bit 1       | PIN\_DJ32 | 1.1-V        |

| led2   | bit 2       | PIN\_DN22 | 1.1-V        |

| led3   | bit 3 (MSB) | PIN\_DP23 | 1.1-V        |
...
&#x20;   wire \[25:0] limit = sw3 ? 26'd12\_499\_999 : 26'd49\_999\_999;
